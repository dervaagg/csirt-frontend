...
export default function NewsV5() {
  return (
    <div>
        <section>
        {
            NewsViewData.News5.map(({newsvImage, title, category}, index)=>{
                return(
        ...
        <section>
        {
            NewsViewData.News5.map(({sub_title1, sub_title2, sub_title3, paragraf1, paragraf2, paragraf3}, index)=>{
                return(
